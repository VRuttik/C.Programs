...
int main(){
    ...
    do{
      ...
      case 1:
        printf("\n Enter the real and imaginary parts of the first complex numbers: ");
        scanf("%d %d", &c1.real, &c1.imag);
        printf("\n Enter the real and imaginary parts of the second complex numbers: ");
      ...
      case 4:
        ...
        printf("\n The sum of two complex number is: %d + %di", sub_c.real, sub_c.imag);
        break;  
