...
#include<string.h>
    ...
    int main(){
        ...
        do{
            ...
            {
            case 1:
                printf("\n Enter the first distance in the kms and meters: ");
                scanf("%d %d", &d1.kms, &d1.meters);
                printf("\n Enter the second distance in the kms and meters: ");
            ...
            case 4:
                ...
                printf("\n The difference of two distance is: %d kms %d meters", d4.kms, d4.meters); 
                break;    
